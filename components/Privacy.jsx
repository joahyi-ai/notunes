        ...
        <div className="prose">
          ...
          <p>
            ...
            <a href="https://www.chatbase.co/terms">
              https://www.chatbase.co/terms
            </a>{" "}
            (“Terms of Service”) which include the terms of the Privacy Policy
            set forth below. Chatbase.co (“Company”) operates the Service.We use
          ...
          <h5>2. Definitions</h5>
          <p>
            <b>API</b> means Chatbase application programming interface to be
          ...
          <p>
            ...
            <a href="https://chatbase.co">chatbase.co</a>.
          </p>
          <p>
            <b>Widget</b> means a Chatbase widget that may be implemented to the
            User’s website.
          </p>
          <h5>3. The Data Controller</h5>
          <p>The controller of your Personal Data is: Chatbase.co.</p>
          ...
          <h5>6. Use of Data</h5>
          <p>
            Chatbase.co uses the collected Personal Data for various purposes:
          </p>
          <ol type="a">
            <li>
          ...
          <p>
            ...
            email us at support@chatbase.co. Please note that we may ask you to
